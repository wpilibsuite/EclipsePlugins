...
DriveTrain::DriveTrain() :
	...
	leftEncoder.SetDistancePerPulse(static_cast<double>(4.0 / 12.0 * M_PI) / 360.0);
	rightEncoder.SetDistancePerPulse(static_cast<double>(4.0 / 12.0 * M_PI) / 360.0);
#endif
	...
	// frc::LiveWindow::GetInstance()->AddSensor("Drive Train", "Left Encoder",
	// 		&leftEncoder);
	// frc::LiveWindow::GetInstance()->AddSensor("Drive Train", "Right Encoder",
	// 		&rightEncoder);
	// frc::LiveWindow::GetInstance()->AddSensor("Drive Train", "Rangefinder",
	// 		&rangefinder);
	// frc::LiveWindow::GetInstance()->AddSensor("Drive Train", "Gyro", &gyro);
}
 ...
 */
void DriveTrain::Log() {
	frc::SmartDashboard::PutNumber("Left Distance", leftEncoder.GetDistance());
